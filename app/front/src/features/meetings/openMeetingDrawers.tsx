...
/**
 * 파일 드로어(U-7) · 논의/결정 추가 드로어(SPEC-008 U-8)는 **각 드로어 파일이 여는 함수를 갖고** 여기서 다시 내보낸다 —
 * 종료 후 본문(`MeetingDetailBody`)이 이 레지스트리를 import 하면 레지스트리 → 상세 드로어 → 본문 순환이 생기기 때문이다(WORK-008).
 */
export { openAddLineDrawer, openAttachmentFileDrawer };
